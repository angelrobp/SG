...
function createGUI (withStats) {
  ...
  var axisLights = gui.addFolder ('Axis and Lights');
    ...
    axisLights.add(GUIcontrols, 'lightIntensity', 0, 1.0).name('Light intensity :').listen();//EXAMEN
    
    axisLights.add(GUIcontrols, 'activeLight').name('Light on/off :');//EXAMEN
