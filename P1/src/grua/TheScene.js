...
class TheScene extends THREE.Scene {
  ...
  createModel () {
    ...
    var loaderCrane = new THREE.TextureLoader();
    var texturaCrane = loaderCrane.load ("imgs/metal.jpg");
    this.crane = new Crane({material:new THREE.MeshPhongMaterial ({map: texturaCrane})});
